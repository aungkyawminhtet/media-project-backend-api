 ...
 */
router.post("/register", [(0, validator_1.validator)(schema_1.userSchema.bodySchema), users_1.register]);
/**
 * @swagger
 * /api/v1/users/login:
 *   post:
 ...
 */
router.post("/login", [(0, validator_1.validator)(schema_1.userSchema.loginSchema), users_1.login]);
/** @swagger
 * /api/v1/users:
 *   get:
